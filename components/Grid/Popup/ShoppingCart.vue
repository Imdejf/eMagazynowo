...
const shoppingCartActive = ref(false)
const toggleShoppingCart = () => {
  shoppingCartActive.value = !shoppingCartActive.value
}
                        ...
                        <div class="ml-4 flex flex-1 flex-col">
                          <div>
                            ...
                            >
                              ...
                              <p class="ml-4 font-600 text-blue-600">$32.00</p>
                            </div>
                          ...
                          >
                            <p class="text-gray-500">Ilość 1</p>

                            <div class="flex divide-x">
                              <button
                                type="button"
                                class="font-medium px-2 py-1 pl-0 space-x-1 text-blue-400 hover:text-blue-600"
                              >
                                <Icon
